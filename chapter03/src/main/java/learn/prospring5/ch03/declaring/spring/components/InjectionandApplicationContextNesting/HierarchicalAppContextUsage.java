package learn.prospring5.ch03.declaring.spring.components.InjectionandApplicationContextNesting;

import org.springframework.context.support.GenericXmlApplicationContext;
public class HierarchicalAppContextUsage {
    public static void main(String... args) {
        GenericXmlApplicationContext parent = new GenericXmlApplicationContext();
        parent.load("classpath:spring/nestedapplicationcontext/parent-context.xml");
        parent.refresh();
        GenericXmlApplicationContext child = new GenericXmlApplicationContext();
        child.load("classpath:spring/nestedapplicationcontext/child-context.xml");
